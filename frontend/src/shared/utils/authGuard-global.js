...
(function() {
    ...
    function showAuthModal(message) {
        ...
        document.getElementById('auth-guard-close').addEventListener('click', () => modal.remove());
        modal.querySelector('.auth-guard-overlay').addEventListener('click', (e) => {
            if (e.target.classList.contains('auth-guard-overlay')) modal.remove();
        });
