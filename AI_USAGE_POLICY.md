...
- **Duy trì tính nhất quán tài liệu:** Dùng AI để đồng bộ hóa thông tin giữa code và các file tài liệu trong thư mục `Docs/`. AI CHỈ LÀM VIỆC với các file `.md` (Markdown).
...
- **Không phá vỡ Kiến trúc & Document:** Không để AI tự ý thay đổi design pattern hiện tại, cũng không được làm thay đổi cấu trúc tài liệu gốc.
