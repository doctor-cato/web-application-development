...
## 🛠️ 7. Cấu hình Skills AI Cục bộ (Local Skills Config)

Chi tiết quy trình sàng lọc và cấu hình 13 skills kích hoạt và 24 skills loại bỏ cho AI Agent được quản lý tại:

👉 [**`docs/ai-skills-config.md`**](./ai-skills-config.md) hoặc file cấu hình cục bộ [`file:///.agents/config.json`](file:///.agents/config.json) & [`file:///.agents/rules/01-skills-config.md`](file:///.agents/rules/01-skills-config.md).
